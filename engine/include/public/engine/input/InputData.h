...
// Cursor modes
#define CURSOR_MODE_NORMAL            0x00034001
#define CURSOR_MODE_HIDDEN            0x00034002
#define CURSOR_MODE_DISABLED          0x00034003
#define CURSOR_MODE_CAPTURED          0x00034004
...
/*
*    Key State
*    There are three different states for a key, it can
*    either be pressed, held or released. This is also
*    referred to as the action in popular libraries such
*    as GLFW.
*/
#define KEY_STATE_NONE               -1
#define KEY_STATE_RELEASED            0
#define KEY_STATE_PRESSED             1
#define KEY_STATE_HELD                2

//    Ascii numeric keyboard key codes
#define KEY_NONE                    -1
