...
namespace ui
{
    ...
    public:
        ...
        ENGINE_API void AddRectFilled(math::Vector2f min, math::Vector2f max, int32 color, f32 rounding = 0.0F);
        ENGINE_API void AddRectFilled(math::Vector2f min, math::Vector2f max, math::Vector4f color, f32 rounding = 0.0F);
